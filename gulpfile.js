...
const ALL_CSS = PLUGIN_ROOT + "/src/**/*.scss";
const FINAL_CSS = PLUGIN_ROOT + "/src/style.scss";
const FINAL_JS  = ["!" + PLUGIN_ROOT + "dist/main.min.js", PLUGIN_ROOT+ "/src/main.js"];
const ALL_JS = PLUGIN_ROOT + "/src/**/*.js";
